...
const ItemWrapper = ({className, my, children}) => {
  return (
    <div className={cn('w-fit h-fit text-white relative mb-1', my ? 'bg-[#A779F6]' : 'bg-[#202232]', className)}
